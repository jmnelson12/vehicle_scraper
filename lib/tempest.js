...
const callToAutoTempest = async function(params) {
	...
	const base_url = `https://www.autotempest.com/queue-results?make=${make}&model=${model}&radius=${radius}&originalradius=${radius}&saleby=any&simplified=0&transmission=any&zip=${zip}&sites=`;
