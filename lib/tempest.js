...
const callToAutoTempest = async function(params) {
	const base_url =
		"https://www.autotempest.com/queue-results?make=ram&model=promaster3500&radius=-1&originalradius=-1&saleby=any&simplified=0&transmission=any&zip=57042&sort=price_asc&sites=";
